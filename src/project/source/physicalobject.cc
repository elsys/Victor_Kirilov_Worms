...
PhysicalObject::PhysicalObject(string filename, int posX, int posY, int delay, int width, int height, int layer, bool represented_by_velocity, int walk_speed, int time_to_live, explosive_type exp, float radius, Velocity vel, bool makeCollision, string coll_filename, int hp, bouncing_type b) :
